        ...
        <div class="sidebar-menu">
            <ul>
                <li v-for="(item, index) in menuItems" :key="index">
                    <a v-if="!item.children" :href="item.link" class="menu-item"
                        :class="{ active: currentUrl === item.link }" :title="isCollapsed ? item.title : ''">
                    ...
                    <div v-else class="submenu-wrapper" :class="{ 'is-open': item.isOpen }">
                        <div class="menu-item parent" @click="toggleSubmenu(index)" :class="{ 'expanded': item.isOpen }"
                            ...
                            <i v-if="!isCollapsed" class="fas fa-chevron-right arrow-icon"
        ...
        return {
            ...
            menuItems: [
                ...
                },
                {
                    ...
                    isOpen: false,
                    children: [
                        { title: "Hóa đơn", link: "/admin/bills" }
                    ]
                },
                {
                    title: "Hệ thống",
