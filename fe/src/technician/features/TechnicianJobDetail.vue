<template>
  <div class="page">
    ...
    <section class="actions">
      <button class="primary" @click="updateStatus('dang_xu_ly')">Bắt đầu</button>
      <button class="ghost" @click="updateStatus('moi')">Tạm dừng</button>
      <button class="ghost" @click="updateStatus('hoan_thanh')">Hoàn thành</button>
    </section>
  </div>
</template>
